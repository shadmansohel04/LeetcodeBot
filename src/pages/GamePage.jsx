        ...
        <div className="gamePage">
            ...
            <div className="gameRight">
                ...
                <div className="nes-container bottomRight">
                    <button type="button" className="nes-btn is-success">Move1</button>
                    <button type="button" className="nes-btn is-warning">Move2</button>
                    <button type="button" className="nes-btn is-error">Move3</button>
                    <button type="button" className="nes-btn is-primary">Primary</button>
                </div>
            </div>
